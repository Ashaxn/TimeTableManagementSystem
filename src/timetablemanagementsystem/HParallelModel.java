 ...
 * @author user
 */
public class HParallelModel {
    private int parallel_id; 
    private String parallel_name;
    ...
    public HParallelModel(int parallel_id, String parallel_name, int sessionid1, int sessionid2, String SubCode1,String SubCode2,String SubName1, String SubName2, String Tag1, String Tag2){
        this.parallel_id = parallel_id;
        this.parallel_name = parallel_name; 
     ...
     public int getparallel_id() {
        return parallel_id;
    }

    public void setparallel_id(int parallel_id) {
        this.parallel_id = parallel_id;
    }
    
    public void setparallel_name(String parallel_name) {
        this.parallel_name = parallel_name;
    }
    
     public String getparallel_name() {
